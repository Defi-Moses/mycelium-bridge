...
export const arbitrumGraphClient = createClient(
  "https://api.thegraph.com/subgraphs/name/mycelium-ethereum/myc-swaps-stats"
);
...
export const arbitrumTestnetReferralsGraphClient = createClient(
  "https://api.thegraph.com/subgraphs/name/mycelium-ethereum/myc-swaps-testnet-referrals"
);
